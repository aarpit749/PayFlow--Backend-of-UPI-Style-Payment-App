...
✅ How to Run
1) Clone
Shellgit clone <your-repo-url>cd payflow-api``Show more lines
...
Open H2 console
URL:
http://localhost:1005/h2-console
...
SQL[PASTE CREATE TABLE USERS ... HERE]Show more lines
TRANSACTIONS table create statement
SQL[PASTE CREATE TABLE TRANSACTIONS ... HERE]Show more lines
...
Shellcurl -X POST http://localhost:1005/users \-H "Content-Type: application/json" \-d '{"name":"Arpit","upiId":"arpit@okaxis","phoneNumber":"9876543210","balance":100Show more lines
Output:
JSON[PASTE OUTPUT HERE]Show more lines
2) Register second user — POST /users
Shellcurl -X POST http://localhost:1005/users \-H "Content-Type: application/json" \-d '{"name":"Priya","upiId":"priya@okaxis","phoneNumber":"9123456789","balance":500}'Show more lines
Output:
JSON[PASTE OUTPUT HERE]Show more lines
3) List all users — GET /users
Shellcurl http://localhost:1005/usersShow more lines
Output:
JSON[PASTE OUTPUT HERE]Show more lines
4) Get user by ID — GET /users/{id}
Shellcurl http://localhost:1005/users/1Show more lines
Output:
JSON[PASTE OUTPUT HERE]Show more lines
5) Send money (record transaction) — POST /transactions
Shellcurl -X POST http://localhost:1005/transactions \-H "Content-Type: application/json" \-d '{"senderUpiId":"arpit@okaxis","receiverUpiId":"priya@okaxis","amount":200,"note":"Dinner split"}'Show more lines
Output:
JSON[PASTE OUTPUT HERE]Show more lines
...
SQLSELECT * FROM USERS;SELECT * FROM TRANSACTIONS;Show more lines
...
Example:
Shellcurl http://localhost:1005/users/upi/arpit@okaxisShow more lines
Output:
JSON[PASTE OUTPUT HERE]``Show more lines
...
Example:
Shellcurl http://localhost:1005/users/balance/above/600Show more lines
Output:
JSON[PASTE OUTPUT HERE]Show more lines
